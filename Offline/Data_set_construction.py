...
class MILP_DataSet:
    ...
    def make_Dataset(self,data_set_file=None,MILPdata_file=None):
        ...
        if not data_set_file:
            data_set_file="Offline/Datasets/dataset_dt"+str(int(self.P.dt))+str(int(self.P.dt/0.1))+"_N"+str(self.P.N)+"_"+timestr+".p"
        if not MILPdata_file:
            MILPdata_file="Offline/Datasets/MILP_data_points_"+str(int(self.P.dt))+str(int(self.P.dt/0.1))+"_N"+str(self.P.N)+"_"+timestr+".p"
